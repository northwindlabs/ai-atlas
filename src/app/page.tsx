        ...
        <div className='max-w-7xl mx-auto space-y-12'>
          ...
          <section className='text-center max-w-3xl mx-auto mb-8 px-4 md:px-8'>
            ...
            <p className='mt-4 text-sm text-gray-500 dark:text-gray-400'>
              All services are categorized by their primary function, with country flags indicating
              ...
              >
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
                  {category.services.map((service) => (
                    <ServiceCard key={service.name} service={service} category={category} />
                  ))}
                </div>
        ...
        <div className='max-w-7xl mx-auto'>
          <div className='flex flex-col md:flex-row justify-between items-center gap-6'>
            <div>
              ...
              <p className='mt-2 text-sm text-white/70'>Mapping the European AI landscape</p>
            </div>
            <div className='flex items-center gap-2'>
